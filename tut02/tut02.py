...
z =14
for i in range(8):
    file.at[z,"1"] = list_total[i][0]
    file.at[z,"-1"] = list_total[i][1]
    file.at[z,"2"] = list_total[i][2]
    file.at[z,"-2"] = list_total[i][3]
    file.at[z,"3"] = list_total[i][4]
    file.at[z,"-3"] = list_total[i][5]
    file.at[z,"4"] = list_total[i][6]
    file.at[z,"-4"] = list_total[i][7]
    z+=1
